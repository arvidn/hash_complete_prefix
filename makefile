...
count_prefix : count_prefix.cpp trie.hpp crc32c.cpp
	c++ count_prefix.cpp MurmurHash3.cpp crc32c.cpp -g -o count_prefix -lcrypto -L/opt/local/lib -I/opt/local/include -stdlib=libc++ -lz -Wno-deprecated-declarations -O3 -std=c++11
